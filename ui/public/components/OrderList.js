...
function OrderListContent(props) {
  var num = props.num != -1 ? props.num : props.orders.length;
  var orders = props.orders.slice(0, num);
...
var OrderList = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(OrderList, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(OrderListContent, {
        orders: this.context.getOrders(),
        num: this.props.num != undefined ? this.props.num : -1,
...
_defineProperty(OrderList, "contextTypes", {
