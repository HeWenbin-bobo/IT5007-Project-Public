...
var LoginForm = (0, _component.default)(function () {
  return Promise.resolve().then(function () {
    return _interopRequireWildcard(require('../components/Login/LoginForm'));
  });
});
...
function Login(props) {
  ...
  }, /*#__PURE__*/React.createElement(AuthLayout, null, "Don't have an account? \xA0", /*#__PURE__*/React.createElement(_material.Link, {
    underline: "none",
    variant: "subtitle2",
    href: "/#/register"
  ...
  }, "Enter your details below.")), /*#__PURE__*/React.createElement(AuthSocial, {
    id: "login",
    login: props.login,
    register: props.register
  }), /*#__PURE__*/React.createElement(LoginForm, null), /*#__PURE__*/React.createElement(_material.Typography, {
    variant: "body2",
    align: "center",
    sx: {
      mt: 3,
  ...
  }, "Don't have an account?\xA0", /*#__PURE__*/React.createElement(_material.Link, {
    variant: "subtitle2",
    underline: "hover",
    href: "/#/register"
  }, "Get started"))))));
...
_defineProperty(LoginPage, "contextTypes", {
